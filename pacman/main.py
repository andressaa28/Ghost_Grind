...
def tela_ajuda():
    ...
    # Carregar imagens usadas no jogo (coloque try/except se quiser mensagem amigável caso faltem arquivos)
    img_pocao = pg.image.load("img/pocao.png")
    img_coracao = pg.image.load("img/coracao.png")
    img_turbo = pg.image.load("img/turbo.png")
    img_freeze = pg.image.load("img/freeze.png")
...
class PacMan:
    ...
    def ghost(self):
        ...
        if self.boss_pos != [self.scale * 12, self.scale * 13]:
        ...
        if self.mini_ghost_pos != [self.scale * 12, self.scale * 14.5]:
        ...
        if self.minni_ghost_pos != [self.scale * 14, self.scale * 13]:
        ...
        if self.mmini_ghost_pos != [self.scale * 14, self.scale * 14.5]:
    ...
    def ghost_manager(self):
        ...
        if self.sprite_frame == 60:
            if self.level != 5:
                ...
                if self.boss_pos == [self.scale * 12, self.scale * 13]:
                    self.moving_ghost_into_the_game('preto')
                elif self.mini_ghost_pos == [self.scale * 12, self.scale * 14.5]:
                    self.moving_ghost_into_the_game('mini')                    
                elif self.minni_ghost_pos == [self.scale * 14, self.scale * 13]:
                    self.moving_ghost_into_the_game('minni')
                elif self.mmini_ghost_pos == [self.scale * 14, self.scale * 14.5]:
